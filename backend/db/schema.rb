...
ActiveRecord::Schema[8.0].define(version: 2025_09_30_000200) do
  ...
  create_table "campaigns", force: :cascade do |t|
    ...
    t.index ["deadline"], name: "index_campaigns_on_deadline"
  ...
  create_table "donations", force: :cascade do |t|
    ...
    t.index ["user_id", "status"], name: "index_donations_on_user_id_and_status"
  ...
  create_table "otps", force: :cascade do |t|
    ...
    t.index ["phone_number"], name: "index_otps_on_phone_number"
  end
